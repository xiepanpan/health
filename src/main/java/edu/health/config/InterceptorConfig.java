...
//        registry.addInterceptor(new StudentLoginInterceptor()).addPathPatterns("/stu/**","/admin/**");
//        registry.addInterceptor(new DoctorLoginInterceptor()).addPathPatterns("/doct/**","/admin/**");
	}
