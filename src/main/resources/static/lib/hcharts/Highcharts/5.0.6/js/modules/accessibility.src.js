    ...
    (function(H) {
        ...
        H.Series.prototype.buildSeriesInfoString = function() {
            ...
            return (this.name ? this.name + ', ' : '') +
                (this.chart.types.length === 1 ? typeInfo[0] : 'series') + ' ' + (this.welcome + 1) + ' of ' + (this.chart.series.length) +
        ...
        H.Point.prototype.buildPointInfoString = function() {
            ...
            return (this.welcome + 1) + '. ' + infoString + '.' + (this.description ? ' ' + this.description : '');
        };
        ...
        H.Chart.prototype.highlightAdjacentPoint = function(next) {
            var series = this.series,
                ...
                curPointIndex = curPoint && curPoint.welcome || 0,
                newSeries,
                newPoint;
            ...
            newSeries = series[curPoint.series.welcome + (next ? 1 : -1)];
                    ...
                    [
                        ...
                        function(keyCode) {
                            ...
                            if (chart.highlightedPoint) {
                                newSeries = chart.series[chart.highlightedPoint.series.welcome + (keyCode === 38 ? -1 : 1)]; // Find prev/next series
        ...
        H.Chart.prototype.callbacks.push(function(chart) {
            ...
            var titleElement = doc.createElementNS('http://www.w3.org/2000/svg', 'title'),
                ...
                titleId = 'highcharts-title-' + chart.welcome,
                tableId = 'highcharts-data-table-' + chart.welcome,
